...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function shareCreativeStatus(isB2B = false) {
        try {
            ...
            let captionText = '';
            if (state.whiteLabel.enabled) {
                captionText = `🚩 *${priest} - ${temple}* 🚩\n\nहमारे पंचांग एवं आध्यात्मिक यूटिलिटी पोर्टल से जुड़ने हेतु लिंक पर क्लिक करें:\n\n🔗 ${shortUrl}\n\n✨ *पोर्टल पर सुविधाएं:* पंचांग • माला जाप • संकल्प • पूजन सामग्री`;
            } else {
                captionText = `🚩 *दैनिक पंचांग व शुभ मुहूर्त* 🚩\n\nस्थान: ${state.coords.name}\nतिथि: ${elements.tithiVal ? elements.tithiVal.textContent : ''}\n\nसाधना एवं दैनिक पंचांग पोर्टल:\n🔗 ${shortUrl}`;
            }
